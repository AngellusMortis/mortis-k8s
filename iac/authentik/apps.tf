...
resource "authentik_provider_oauth2" "cloudflare" {
    ...
    allowed_redirect_uris = [
        {matching_mode = "strict", url = "https://mortis.cloudflareaccess.com/cdn-cgi/access/callback"}
    ]
...
resource "authentik_provider_oauth2" "grafana" {
    ...
    client_type = "confidential"
    allowed_redirect_uris = [
        {matching_mode = "strict", url = "https://monitor.wl.mort.is/login/generic_oauth"}
    ]
...
resource "authentik_provider_oauth2" "k8s" {
    ...
    client_type = "confidential"
    allowed_redirect_uris =[
        {matching_mode = "strict", url = "https://k8s.wl.mort.is/oauth2/callback"},
