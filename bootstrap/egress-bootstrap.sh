...
# curl -sL https://files.wl.mort.is/egress-bootstrap.sh -o bootstrap.sh && sh bootstrap.sh
...
function install_nix() {
    ...
    curl -sL https://files.wl.mort.is/egress.nix -o /mnt/etc/nixos/configuration.nix
